        ...
        <footer class="p-4 bg-[#eee] md:p-8 lg:p-10 dark:bg-gray-800">
            <div class="mx-auto max-w-screen-xl text-center">
                ...
                <ul class="flex flex-wrap justify-center items-center mb-6  text-gray-900 dark:text-white">
                    ...
                    <li>
                        <a href="#" class="mr-4 hover:underline md:mr-6">How it works</a>
                    </li>
                    <li>
                ...
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">The Astutian™</a>. All Rights Reserved.</span>
            </div>
    </footer>
  )
}
