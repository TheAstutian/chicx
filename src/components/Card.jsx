  ...
  return (
    <div className="group my-3 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
        ...
        <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
            ...
            <img className="peer absolute top-0 -right-96 h-full w-full object-cover transition-all delay-100 duration-1000 hover:right-0 peer-hover:right-0" src="https://m.media-amazon.com/images/I/61R+XI5OkOL.jpg" alt="product image" />
            ...
            <span className="absolute top-0 left-0 m-2 rounded-full bg-secondary px-2 text-center text-xs font-normal text-white">39% OFF</span>
        </a>
