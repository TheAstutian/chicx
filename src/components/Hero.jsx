  ...
  return (
    <section className='bg-white dark:bg-gray-900'>
        ...
        <div className='mr-auto place-self-center lg:col-span-7'>
            ...
            <a href='#' className='inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-thin text-center text-white rounded-lg bg-secondary hover:bg-primary hover:text-black  focus:ring-4 focus:ring-primary dark:focus:ring-primary'>
                See market
