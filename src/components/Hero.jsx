  ...
  return (
    <section className='bg-white dark:bg-gray-900'>
        ...
        <div className='mr-auto place-self-center lg:col-span-7'>
            ...
            <Link to='/' className='inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-secondary border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800'> 
            How e dey work</Link>
        </div>
