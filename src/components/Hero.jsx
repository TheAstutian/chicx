...
const Hero = () => {
  return (
    <section className='bg-white dark:bg-gray-900'>
        ...
        <div className=' mr-auto  place-self-center md:col-start-2 md:col-span-5'>
        ...
        <div className='hidden  md:place-self-right md:mt-0 md:col-end-9 md:col-span-1 md:flex '>
