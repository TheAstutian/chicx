  ...
  return (
    <section className='bg-white '>
        ...
        <div className=' mr-auto  place-self-center md:col-start-2 md:col-span-4'>
            <h1 className='max-w-2xl mb-4 text-4xl text-black font-medium tracking-tight leading-none md:text-5xl xl:text-6xl'>Goldyvhista Hubz</h1>
            ...
            <Link to='/products' className='inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-sm bg-primary hover:bg-secondary hover:text-white  focus:ring-4 focus:ring-primary '>
               Start Shopping
