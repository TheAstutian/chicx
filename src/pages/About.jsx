...
const About = () => {
  return (
    <div className='bg-white sm:pb-20 sm:mb-10 sm:pt-10'>
        <div className='pl-5 md:pl-10 pt-5 md:ml-10 mt-5 w-full'>
            <h1 className='text-tertiary font-semibold text-2xl md:text-5xl p-2 md:pl-10 md:ml-10'>About Goldyvhista Hubz</h1>
        </div>
